...
class ArgentinaVsBrazil extends StatelessWidget {
  const ArgentinaVsBrazil({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: false,
        title: const Text('Argentina Vs Brazil'),
      ),
      body: StreamBuilder(
        stream: FirebaseFirestore.instance
            .collection('football')
            .doc('YcrtzoV2vsURTfPBemCf')
            .snapshots(),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            score.get('score_team_one').toString(),
                          ...
                          Text(
                            score.get('score_team_two').toString(),
                            style: const TextStyle(fontSize: 28,fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
